...
import (
	...
	"github.com/djedjethai/goframework/urlsigner"
)
...
func (h *Handlers) PostUserLogin(w http.ResponseWriter, r *http.Request) {
	...
	// as it s a checkbox it will be populated only if checked
	if r.Form.Get("remember") == "remember" {
		// if user wants to be remember, use a random string
...
func (h *Handlers) UserLogout(w http.ResponseWriter, r *http.Request) {
	// delete the remember token if it exist
	...
	// delete cookie, to do it set an expired one
	...
	// no need to renew but makes sure the old one has been deleted
	h.App.Session.RenewToken(r.Context())
